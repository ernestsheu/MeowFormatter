...
namespace Microsoft.LanguageServer.Protocol {
    ...
    [LSPRequest("completionItem/resolve", typeof(CompletionItemResolveResponse))]
    [DataContract]
    public record CompletionItemResolveRequest: IRequest<CompletionItem>
    {
        [JsonConstructor]
        public CompletionItemResolveRequest(
            OrType<string, int> id,
            string method,
            CompletionItem paramsValue,
            string jsonrpc = "2.0"
        )
        {
            JsonRPC = jsonrpc;
        ...
        public CompletionItem Params { get; init; }
    }
