...
namespace Microsoft.LanguageServer.Protocol {
    ...
    [LSPRequest("codeAction/resolve", typeof(CodeActionResolveResponse))]
    [DataContract]
    public record CodeActionResolveRequest: IRequest<CodeAction>
    {
        [JsonConstructor]
        public CodeActionResolveRequest(
            OrType<string, int> id,
            string method,
            CodeAction paramsValue,
            string jsonrpc = "2.0"
        )
        {
            JsonRPC = jsonrpc;
        ...
        public CodeAction Params { get; init; }
    }
